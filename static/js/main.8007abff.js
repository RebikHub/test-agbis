...
/******/ 	__webpack_require__.p = "/test-agbis/";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shim = __webpack_require__(29);
	
	var _withSelector = __webpack_require__(81);
	
	var _reactBatchedUpdates = __webpack_require__(70);
	
	var _batch = __webpack_require__(23);
	
	var _useSelector = __webpack_require__(20);
	
	var _connect = __webpack_require__(17);
	
	var _exports = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.removeService = exports.deleteOrder = exports.addOrder = exports.sliceCart = undefined;
	
	var _toolkit = __webpack_require__(7);
	...
	var sliceCart = exports.sliceCart = (0, _toolkit.createSlice)({
	  name: 'sliceCart',
	  initialState: {
	    order: []
	  },
	  reducers: {
	    addOrder: function addOrder(state, actions) {
	      var list = [].concat(_toConsumableArray(state.order));
	
	      if (list.some(function (e) {
	        return e.service === actions.payload.service;
	      })) {
	        list.map(function (el) {
	          if (el.service === actions.payload.service) {
	            if (el.clothes.some(function (elem) {
	              return elem.name === actions.payload.clothes.name && elem.price === actions.payload.clothes.price;
	            })) {
	              el.clothes.map(function (elem) {
	      ...
	      state.order = [].concat(_toConsumableArray(list));
	    },
	    deleteOrder: function deleteOrder(state, actions) {
	      var list = [].concat(_toConsumableArray(state.order));
	      var index = null;
	      list.map(function (e, i) {
	        if (e.service === actions.payload.service) {
	          e.clothes = e.clothes.filter(function (el) {
	            return el.name !== actions.payload.clothes.name && el.price !== actions.payload.clothes.price;
	          });
	        };
	      });
	
	      state.order = list.filter(function (e) {
	        return e.clothes.length > 0;
	      });
	    },
	    removeService: function removeService(state, actions) {
	      state.order = state.order.filter(function (e) {
	        return e.service !== actions.payload;
	      });
	    }
	  }
	});
	
	var _sliceCart$actions = sliceCart.actions,
	    addOrder = _sliceCart$actions.addOrder,
	    deleteOrder = _sliceCart$actions.deleteOrder,
	    removeService = _sliceCart$actions.removeService;
	exports.addOrder = addOrder;
	exports.deleteOrder = deleteOrder;
	exports.removeService = removeService;
	exports.default = sliceCart.reducer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactIs = __webpack_require__(58);
	
	var _selectorFactory = _interopRequireDefault(__webpack_require__(63));
	
	var _mapDispatchToProps = __webpack_require__(60);
	
	var _mapStateToProps = __webpack_require__(61);
	
	var _mergeProps = __webpack_require__(62);
	
	var _Subscription = __webpack_require__(22);
	
	var _useIsomorphicLayoutEffect = __webpack_require__(25);
	...
	var _useSyncExternalStore = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _verifyPlainObject = _interopRequireDefault(__webpack_require__(27));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useReduxContext = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isPlainObject = _interopRequireDefault(__webpack_require__(69));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defaultMemoize = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ShoppingCart = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sliceCart = __webpack_require__(8);
	
	__webpack_require__(5);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function ClothesItem(_ref) {
	  var item = _ref.item,
	  ...
	  function clickAddBtn() {
	    ...
	    if (none === 'none') {
	      setNone('');
	      dispatch((0, _sliceCart.addOrder)({
	        service: service,
	        clothes: {
	          name: item.name,
	          price: item.price,
	  ...
	  (0, _react.useEffect)(function () {
	    if (amount < 1) {
	      setNone('none');
	      dispatch((0, _sliceCart.deleteOrder)({
	        service: service,
	        clothes: {
	          name: item.name,
	          price: item.price,
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'clothes-list-item' },
	    _react2.default.createElement(
	      'div',
	      { className: 'clothes-left' },
	      _react2.default.createElement(
	        'p',
	        { className: 'clothes-name' },
	        item.name
	      ),
	      _react2.default.createElement(
	        'p',
	        { className: 'clothes-more' },
	        '\u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435',
	        _react2.default.createElement('span', { className: 'more-img' })
	      )
	    ),
	    _react2.default.createElement(
	      'div',
	      { className: 'clothes-order' },
	      _react2.default.createElement(
	        'p',
	        { className: 'clothes-price' },
	        item.price,
	        '\u20BD'
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'clothes-add' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ClothesItem = __webpack_require__(35);
	
	var _ClothesItem2 = _interopRequireDefault(_ClothesItem);
	...
	function ClothesList(_ref) {
	  ...
	  return _react2.default.createElement(
	    'ul',
	    { className: 'clothes-list' },
	    list.map(function (e, i) {
	      return _react2.default.createElement(
	        'li',
	        { key: e.name + i },
	        _react2.default.createElement(_ClothesItem2.default, { item: e, service: service })
	      );
	    })
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function DropdownLang() {
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'header-lang', onClick: clickDrop },
	    _react2.default.createElement(
	      'div',
	      { className: 'lang-selected ' + (none === '' ? 'none' : '') },
	      _react2.default.createElement(
	        'p',
	        { className: 'lang-text' },
	        lang
	      ),
	      _react2.default.createElement('span', { className: 'lang-arrow' })
	    ),
	    _react2.default.createElement(
	      'div',
	      { className: 'lang-dropdown ' + none },
	      _react2.default.createElement(
	        'p',
	        { className: 'drop-lang lang-text', onClick: choiceLang },
	        'RU'
	      ),
	      _react2.default.createElement('span', { className: 'drop-line' }),
	      _react2.default.createElement(
	        'p',
	        { className: 'drop-lang lang-text', onClick: choiceLang },
	        'ENG'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DropdownLang = __webpack_require__(37);
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'span',
	          { className: 'header-icon icon-instagram' },
	          _react2.default.createElement('a', { href: '#' })
	        ),
	        _react2.default.createElement(
	          'span',
	          { className: 'header-icon icon-facebook' },
	          _react2.default.createElement('a', { href: '#' })
	        ),
	        _react2.default.createElement(
	          'span',
	          { className: 'header-icon icon-whatsapp' },
	          _react2.default.createElement('a', { href: '#' })
	        ),
	        _react2.default.createElement(
	          'span',
	          { className: 'header-icon icon-viber' },
	          _react2.default.createElement('a', { href: '#' })
	        )
	      ),
	      _react2.default.createElement(_DropdownLang2.default, null)
	    ),
	    _react2.default.createElement(
	      'div',
	      { className: 'header-navigation' },
	      _react2.default.createElement('div', { className: 'header-menu' }),
	      _react2.default.createElement(
	        'div',
	      ...
	      _react2.default.createElement(
	        'button',
	        { className: 'header-btn', type: 'button' },
	        '\u041F\u0440\u0430\u0439\u0441-\u043B\u0438\u0441\u0442'
	      )
	    )
	  );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ClothesList = __webpack_require__(36);
	...
	var _ServicesList = __webpack_require__(41);
	...
	function Main() {
	  var _useState = (0, _react.useState)([]),
	      _useState2 = _slicedToArray(_useState, 2),
	      listClothes = _useState2[0],
	      setListClothes = _useState2[1];
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(_ServicesList2.default, { choiceClothes: choiceClothes })
	    ),
	    _react2.default.createElement(
	      'section',
	      { className: 'main-body' },
	      ...
	      _react2.default.createElement(_ClothesList2.default, { list: listClothes, service: service })
	    )
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function ServicesList(_ref) {
	  var choiceClothes = _ref.choiceClothes;
	
	  var services = (0, _reactRedux.useSelector)(function (state) {
	    return state.sliceData;
	  });
	  ...
	  function clickService(index) {
	    if (id.service === null) {
	      setId(Object.assign({}, id, { service: index }));
	    } else {
	  ...
	  function clickClothes(index, list, service) {
	    if (id.clothes === null) {
	      setId(Object.assign({}, id, { clothes: index }));
	      choiceClothes(list, service);
	    } else if (id.clothes === index) {
	      setId(Object.assign({}, id, { clothes: null }));
	    } else {
	      setId(Object.assign({}, id, { clothes: index }));
	      choiceClothes(list);
	    };
	  ...
	  return _react2.default.createElement(
	    'nav',
	    { className: 'nav' },
	    services.map(function (e, i) {
	      return _react2.default.createElement(
	        'div',
	        { className: 'nav-service', key: i },
	        _react2.default.createElement(
	          'p',
	          {
	            className: 'nav-title' + (i === id.service ? '-focus' : ''),
	            onClick: function onClick() {
	              return clickService(i);
	            } },
	          e.name,
	          _react2.default.createElement('span', { className: 'nav-img' + (i === id.service ? '-invert' : '') })
	        ),
	        _react2.default.createElement(
	          'ul',
	          { className: 'service-list ' + (i === id.service ? '' : 'none') },
	          e.clothes.map(function (el, index) {
	            return _react2.default.createElement(
	              'li',
	              {
	                className: 'clothes-item' + (index === id.clothes ? '-focus' : ''),
	                onClick: function onClick() {
	                  return clickClothes(index, el.clothes_type, e.name);
	                },
	                key: index },
	              _react2.default.createElement(
	                'p',
	                { className: 'clothes-text' },
	                el.type
	              )
	            );
	          })
	...
	function ShoppingCart() {
	  ...
	  function updateCart(object) {
	    if (object.clothes.amount > 0) {
	      dispatch((0, _sliceCart.addOrder)(object));
	    } else {
	      dispatch((0, _sliceCart.deleteOrder)(object));
	    };
	  };
	
	  function removeOrder(service) {
	    dispatch((0, _sliceCart.removeService)(service));
	  };
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'p',
	              { className: 'cart-amount-text' },
	              '\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u0443\u0441\u043B\u0443\u0433 \u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0435'
	            ),
	            _react2.default.createElement(
	              'p',
	              { className: 'cart-amount-number' },
	              sum.amount
	            )
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'p',
	              { className: 'cart-sum-text' },
	              '\u0421\u0443\u043C\u043C\u0430 \u0437\u0430\u043A\u0430\u0437\u0430'
	            ),
	            _react2.default.createElement(
	              'p',
	              { className: 'cart-sum-number' },
	              sum.price,
	              '\u20BD'
	            )
	          )
	        ...
	        none && _react2.default.createElement(
	          ...
	          order.map(function (e, i) {
	            return _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement('span', { className: 'order-desc-close', onClick: function onClick() {
	                    return removeOrder(e.service);
	                  } }),
	                e.clothes.map(function (el, index) {
	                  return _react2.default.createElement(
	                    'div',
	                    { className: 'order-desc-body', key: index },
	                    _react2.default.createElement(
	                      'p',
	                      { className: 'order-desc-text' },
	                      el.name
	                    ),
	                    _react2.default.createElement(
	                      'div',
	                      { className: 'order-desc-amount' },
	                      _react2.default.createElement(
	                        'p',
	                        { className: 'order-desc-sum' },
	                        el.price,
	                        '\u20BD'
	                      ),
	                      _react2.default.createElement(
	                        'div',
	                        { className: 'order-desc-add' },
	                        _react2.default.createElement('span', {
	          ...
	          _react2.default.createElement(
	            'button',
	            { className: 'order-btn', type: 'button' },
	            '\u041E\u0444\u043E\u0440\u043C\u0438\u0442\u044C \u0437\u0430\u043A\u0430\u0437'
	          )
	        )
	      ),
	      _react2.default.createElement('button', { className: 'cart-arrow-btn' + (none ? '-invert' : ''), type: 'button', onClick: function onClick() {
	          return setNone(!none);
	        } })
	    ),
	    none && _react2.default.createElement('div', { className: 'body-background' })
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.sliceData = undefined;
	
	var _toolkit = __webpack_require__(7);
	
	var sliceData = exports.sliceData = (0, _toolkit.createSlice)({
	  name: 'sliceData',
	  initialState: [{
	    name: 'Химчистка',
	    clothes: [{
	...
	exports.default = sliceData.reducer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sliceCart2 = _interopRequireDefault(_sliceCart);
	
	var _sliceData = __webpack_require__(44);
	
	var _sliceData2 = _interopRequireDefault(_sliceData);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var store = exports.store = (0, _toolkit.configureStore)({
	  reducer: {
	    sliceCart: _sliceCart2.default,
	    sliceData: _sliceData2.default
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	'use strict';var aa=__webpack_require__(1),ca=__webpack_require__(76);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bindActionCreators = _interopRequireDefault(__webpack_require__(68));
	
	var _wrapMapToProps = __webpack_require__(18);
	
	var _invalidArgFactory = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _verifySubselectors = _interopRequireDefault(__webpack_require__(64));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Provider = _interopRequireDefault(__webpack_require__(59));
	
	var _connect = _interopRequireDefault(__webpack_require__(17));
	
	var _Context = __webpack_require__(3);
	
	var _useDispatch = __webpack_require__(66);
	
	var _useSelector = __webpack_require__(20);
	
	var _useStore = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.assign = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * LICENSE file in the root directory of this source tree.
	 */
	'use strict';var h=__webpack_require__(1),n=__webpack_require__(29);function p(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var q="function"===typeof Object.is?Object.is:p,r=n.useSyncExternalStore,t=h.useRef,u=h.useEffect,v=h.useMemo,w=h.useDebugValue;
...
/***/ }
/******/ ])));
//# sourceMappingURL=main.8007abff.js.map